...
//создание начерченногно круга d.emelin
        ...
        var centerX = 770,
            ...
            angles = []
        var angle;
        var stupid_count = 5+Ro/100
        for (var new_radius = radius; new_radius < 500; new_radius += 100) {
            stupid_count -= 1
            const rndInt = randomIntFromInterval(1, stupid_count)
            for (var i = 0; i < 360; i += 10) {
                ...
                ctx.lineTo(
                    centerX + Math.sin(angle) * (new_radius + width - 10 * stupid_count),
...
//создание начерченногно круга d.emelin конец
